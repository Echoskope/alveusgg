...
const data: RootNetworkItem[] = [
  {
    type: "switch",
    name: "Aggregation",
    model: "Ubiquiti USW-Pro-Aggregation",
    url: "https://store.ui.com/us/en/category/switching-aggregation/products/usw-pro-aggregation",
    ...
    links: [
      {
        ...
        ], // CLose of the Studio Links
      }, // Close of the Studio Swtich
      {
        type: "switch",
        name: "HQ",
      ...
      }, // Close of HQ
      {
        ...
        model: "Ubiquiti USW-Lite-8-PoE",
        url: "https://store.ui.com/us/en/pro/category/switching-utility/products/usw-lite-8-poe",
        connection: { type: "fiber", location: "overhead" },
        links: [
          /*
          {
            type: "camera",
        ...
        ], // Close of Training Center Links
      }, // Close of Training Center Switch
      {
        type: "switch",
        name: "Pasture",
        model: "Ubiquiti USW-Lite-8-PoE",
        ...
        ], // Close of Pastue Links
      }, // Close of Pasture Switch

      {
        ...
        ], // Close of Parrot Links
      }, // Close of Parrot Switch
      {
        type: "switch",
        ...
        ], // Close of Nut House Links
      }, // Close of Nut House Switch
      {
        type: "switch",
        name: "Tort",
